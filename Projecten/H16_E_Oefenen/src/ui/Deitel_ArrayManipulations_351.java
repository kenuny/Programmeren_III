...
public class Deitel_ArrayManipulations_351 {
	...
	public static void main(String[] args) {
		 ...
		 * Arrays.copyOf(teKopiërenArray, aantalElementenKopiëren)
		 * 
		 * Manier2: Met behulp van de Klasse System. Methode:
		 * System.arraycopy(toKopiërenArray, startpositie kopiëren, naarKopiërenArray,
		 * startpositie plakken, aantalElementenKopiëren)
		 */

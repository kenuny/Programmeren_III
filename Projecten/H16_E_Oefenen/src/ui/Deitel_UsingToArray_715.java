...
public class Deitel_UsingToArray_715 {
	...
	public static void main(String[] args) {
		...
		/*
		 * Maakt een array en linkedlist aan. Array wordt doorgegeven aan de linkedlist.
		 * Arrays.asList(array). Vervolgens elementen toevoegen aan de lijst. Lijst
		 * terug omzetten naar array en printen.
		 */

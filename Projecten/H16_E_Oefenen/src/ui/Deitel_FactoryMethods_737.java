...
public class Deitel_FactoryMethods_737 {
	...
	public static void main(String[] args) {
		...
		// methode 1
		Map<String, Integer> dayMap = Map.of("Monday", 1, "Tuesday", 2, "Wednesday", 3, "Thursday", 4, "Friday", 5,
				"Saturday", 6, "Sunday", 7);
		System.out.printf("dayMap: %s%n%n", dayMap);

		// methode 2
		Map<String, Integer> monthMap = Map.ofEntries(Map.entry("January", 31), Map.entry("february", 28),
				Map.entry("March", 31), Map.entry("April", 30), Map.entry("May", 31), Map.entry("June", 30),
				Map.entry("July", 31), Map.entry("August", 31), Map.entry("September", 30), Map.entry("October", 31),

...
public class TestLeesBestand {
	...
	private final Object[][] resultaat = { { "WestVleteren_Blond", 5.0 }, { "Tripel_Kanunnik", 8.2 },
			{ "Black_Albert", 13.0 }, { "Rochefort_10", 11.0 }, { "Alpaïde", 9.5 }, { "Cantillon_Geuze", 5.0 },
			{ "Moinette_Blonde", 8.5 }, { "Wilderen_Goud", 6.0 }, { "Tripel_Karmeliet", 8.4 },
			{ "Westmalle_Tripel", 9.5 }, };

	private MyListIterable<Bier> leesBestand() {
		try (ObjectInputStream in = new ObjectInputStream(
				Files.newInputStream(new File("bierenListObj.dat").toPath()))) {

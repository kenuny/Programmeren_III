...
public class OefFruit1_opgave {
    ...
    public static void main(String args[]) {
        ...
        // Door elk element dat in x_dynamischeLijst zit wordt verwijdert uit y_dynamischeLijst
        ...
        // Door elk element dat in y_dynamischeLijst zit wordt verwijdert uit x_dynamischeLijst
        ...
        System.out.printf("x_dynamischeLijst en y_dynamischeLijst hebben gemeenschappelijk: %s%n%n", gemeenschappelijkeObjecten);
        
        
        /*
         * Bewerkingen:
         * 		Arrays.asList(array1)    -> Zet een array om in een statische lijst.
         * 		lijst1.removeAll(lijst2) -> verwijdert alle elementen in lijst1 die in lijst2 zitten.
         * 		lijst1.retainAll(lijst2) -> verwijdert alle elementen in lijst1 die niet in lijst2 zitten.
         * 		List<String> lijst__dynamisch = new ArrayList<>(lijst__statisch) -> maakt van een statische lijst een dynamische lijst.
         * 
         * Verschil statische lijst en dynamische lijst:
         * 		Op een statische lijst kunnen enkel statische bewerkingen gedaan worden zoals System.out.print() en size().
         *  	Maar op een statische lijst kan geen bewerking zoals remove() of contains(). 
         *  	Op een dynamische lijst zijn zowel statische als dynamische bewerkingen mogelijk. (Werk steeds met dynamische lijsten).
		*/

...
public class BierApplicatie {
	...
	public void run() {
		...
		domeinController.geefLijstAlleBierenMetMinAlcoholPercentage(8).forEach(bier -> System.out.println(bier));
		...
		System.out.println("Bier met hoogste aantal graden: " + domeinController.geefBierMetHoogsteAlcoholPercentage());

		// Bier met laagst aantal graden
		System.out.println("======================================================");
		System.out.println("Bier met laagst aantal graden");
		System.out.println("Bier met laagste aantal graden: " + domeinController.geefBierMetLaagsteAlcoholPercentage());

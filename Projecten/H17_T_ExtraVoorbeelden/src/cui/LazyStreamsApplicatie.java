...
/**
 * Voorbeeld overgenomen uit "Functional Programming in Java" van Venkat
 * Subramaniam.
 */
...
public class LazyStreamsApplicatie {
	...
	public static void main(String[] args) {
		...
		Stream<String> namenMet3letters = names.stream().filter(name -> getLength(name) == 3)
...
//        dat voldoet aan de filter
		String eersteNaamMet3letters = namenMet3letters.findFirst().get();
		System.out.println(eersteNaamMet3letters);

//        Beter:
		eersteNaamMet3letters = namenMet3letters.findFirst().orElse("Geen naam met 3 letters");
		System.out.println(eersteNaamMet3letters);
	}
}
